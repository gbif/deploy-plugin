...
public class Artifact {
  ...
  public static final List<Artifact> DEPLOY_ARTIFACTS =
    new ImmutableList.Builder<Artifact>()
      ...
      .add(new Artifact("org.gbif.checklistbank", "checklistbank-ws", "spring"))
      .add(new Artifact("org.gbif",               "content-ws", "spring"))
      .add(new Artifact("org.gbif.crawler",       "crawler-ws", "spring"))
      .add(new Artifact("org.gbif.datapackages",  "datapackages-ws", "spring"))
      .add(new Artifact("org.gbif.directory",     "directory-ws", "spring"))
      .add(new Artifact("org.gbif.maps",          "event-vectortile-server", "spring"))
      .add(new Artifact("org.gbif.occurrence",    "event-ws", "spring"))
      .add(new Artifact("org.gbif.geocode",       "geocode-ws", "spring"))
      ...
      .add(new Artifact("org.gbif.metrics",       "metrics-ws", "spring"))
      .add(new Artifact("org.gbif.occurrence",    "occurrence-ws", "spring"))
      .add(new Artifact("org.gbif.occurrence",    "occurrence-ws", "spring", "search", 0d))
